...
Requires: pandas, matplotlib (see ``requirements.txt``).
    ...
    python scripts/16_eda_visualize_fakenews_tsv.py
    python scripts/16_eda_visualize_fakenews_tsv.py --input data/fakenews.tsv --out-dir outputs/fakenews_viz
...
<body>
  ...
  <p>Source: <code>{src.name}</code> — {n:,} rows. Generated by <code>scripts/16_eda_visualize_fakenews_tsv.py</code>.</p>
